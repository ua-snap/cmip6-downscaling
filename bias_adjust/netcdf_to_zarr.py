...
example usage:
    python netcdf_to_zarr.py \
        --netcdf_dir /path/to/era5_data/ \
        --year_str t2max/t2max_{year}_era5_12km_3338.nc \
        --start_year 1965 --end_year 2014 \
        --zarr_path /path/to/output/era5_t2max.zarr
"""
...
if __name__ == "__main__":
    ...
    try:
        validate_zarr_readback(zarr_path, var_id)
